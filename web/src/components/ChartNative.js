...
!(function(t, e) {
      ...
      const { titleX: c, titleY: h, maxWidth: d, rotation: u } = (function(t, e, i, n) {
        ...
        return (
          t.isHorizontal()
            ...
            : ((h = Ni(t, i, e)), (d = o(n, r, s)), (u = 'left' === i ? -Mt : Mt)),
  ...
  function jn(t, e, i) {
    ...
    let s = n.get(o);
    if (!s) {
      (s = { resolver: qi(e, i), subPrefixes: i.filter(t => !t.toLowerCase().includes('hover')) }),
        n.set(o, s);
    }
    return s;
  }
      ...
      const o = (function(t, e) {
        ...
        (_ = Math.ceil(u / y) - Math.floor(d / y)),
          ...
          f && g && n && Rt((s - o) / n, y / 1e3)
            ...
            : ((_ = (b - x) / y),
              (_ = Tt(_, Math.round(_), y / 1e3) ? Math.round(_) : Math.ceil(_))),
  ...
  class js extends Ls {
    ...
    drawBackground() {
      ...
      if (e) {
        ...
        n.save(),
          n.beginPath(),
          Ns(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length),
          n.closePath(),
          (n.fillStyle = e),
          n.fill(),
          n.restore();
